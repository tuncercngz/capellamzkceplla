module.exports = {
    ...
    execute(client, message, args) {
        ...
        if (!args[0]) return message.channel.send(`** <a:no:878800816499204157> - Lütfen Geçerli Bir Efekt Filtresi İsmi Yaz!**`);

        const filterToUpdate = client.filters.find((x) => x.toLowerCase() === args[0].toLowerCase());

        if (!filterToUpdate) return message.channel.send(`** <a:no:878800816499204157> - Böyle Bir Efekt Filtresi Yok!**`);
