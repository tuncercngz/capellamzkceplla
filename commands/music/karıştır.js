module.exports = {
    ...
    execute(client, message) {
        ...
        if (success) message.channel.send(`** <a:guvenlik:877315668394000424> - Çalma Listesi Karıştırıldı Şarkı Sırası Değişti | \`${client.player.getQueue(message).tracks.length}\` Toplam Şarkı!**`);
    },
};